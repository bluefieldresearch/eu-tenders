-- WWTP O&M contracts in Spain with company groups
-- Export to CSV: \copy (...) TO 'exports/wwtps_spain.csv' WITH CSV HEADER
...
WHERE (w.objeto_contrato ILIKE '%EDAR%'
   ...
   OR w.objeto_contrato ILIKE '%saneamiento y depuración%')
